 ...
 * @ExclusionPolicy("all")
 */
class BeatSpliceParamsUseFileBeatsMarker extends AbstractTag
{

    protected $Id = 'beatSpliceParamsUseFileBeatsMarker';

    protected $Name = 'BeatSpliceParamsUseFileBeatsMarker';
