 ...
 * @ExclusionPolicy("all")
 */
class ArtworkContributionDescription extends AbstractTag
{

    protected $Id = 'ArtworkOrObjectAOContributionDescription';

    protected $Name = 'ArtworkContributionDescription';
