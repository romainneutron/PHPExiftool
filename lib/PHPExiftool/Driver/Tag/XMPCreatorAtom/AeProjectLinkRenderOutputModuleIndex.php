 ...
 * @ExclusionPolicy("all")
 */
class AeProjectLinkRenderOutputModuleIndex extends AbstractTag
{

    protected $Id = 'aeProjectLinkRenderOutputModuleIndex';

    protected $Name = 'AeProjectLinkRenderOutputModuleIndex';
