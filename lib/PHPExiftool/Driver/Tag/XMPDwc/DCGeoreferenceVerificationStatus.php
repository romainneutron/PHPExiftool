 ...
 * @ExclusionPolicy("all")
 */
class DCGeoreferenceVerificationStatus extends AbstractTag
{

    protected $Id = 'dctermsLocationGeoreferenceVerificationStatus';

    protected $Name = 'DCGeoreferenceVerificationStatus';
