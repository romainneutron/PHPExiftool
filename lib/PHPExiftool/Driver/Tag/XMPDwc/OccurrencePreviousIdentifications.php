 ...
 * @ExclusionPolicy("all")
 */
class OccurrencePreviousIdentifications extends AbstractTag
{

    protected $Id = 'OccurrencePreviousIdentifications';

    protected $Name = 'OccurrencePreviousIdentifications';
