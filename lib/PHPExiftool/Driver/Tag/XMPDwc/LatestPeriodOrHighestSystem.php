 ...
 * @ExclusionPolicy("all")
 */
class LatestPeriodOrHighestSystem extends AbstractTag
{

    protected $Id = 'GeologicalContextLatestPeriodOrHighestSystem';

    protected $Name = 'LatestPeriodOrHighestSystem';
