 ...
 * @ExclusionPolicy("all")
 */
class EarliestEonOrLowestEonothem extends AbstractTag
{

    protected $Id = 'GeologicalContextEarliestEonOrLowestEonothem';

    protected $Name = 'EarliestEonOrLowestEonothem';
