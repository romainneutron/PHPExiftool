 ...
 * @ExclusionPolicy("all")
 */
class IdentificationVerificationStatus extends AbstractTag
{

    protected $Id = 'IdentificationIdentificationVerificationStatus';

    protected $Name = 'IdentificationVerificationStatus';
