 ...
 * @ExclusionPolicy("all")
 */
class PaintCorrectionMaskPerimeterValue extends AbstractTag
{

    protected $Id = 'PaintBasedCorrectionsCorrectionMasksPerimeterValue';

    protected $Name = 'PaintCorrectionMaskPerimeterValue';
